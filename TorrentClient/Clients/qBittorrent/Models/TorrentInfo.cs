...
namespace TorrentClient.Clients.qBittorrent.Models
{
    internal record TorrentInfo
    {
        ...
        public required string content_path { get; init; }
        ...
        public required string magnet_uri { get; init; }
        ...
        public required string save_path { get; init; }
        ...
        [JsonConverter(typeof(JsonStringEnumConverter<TorrentStates>))]
